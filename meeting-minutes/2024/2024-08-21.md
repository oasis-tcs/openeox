...
* There was a suggestion to use "MAY" instead of "can" in the standard, and questions were raised about whether cloud services should be covered by OpenEoX.
...
- It was discussed whether the definition of "end of sales" should include the last order date, which might be more important for customers.

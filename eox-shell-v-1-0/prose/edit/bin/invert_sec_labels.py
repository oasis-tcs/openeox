...
if not ETC_PATH.is_dir():
    raise RuntimeError('Please execute me inside eox-shell-v-1-0/prose/edit/ because I am a simple tool')
...
ordered = {
    'Please do not edit manually!': (
        "Instead, call 'make invert-sections' inside the clone-root/eox-shell-v-1-0/prose/edit folder."
    )
}

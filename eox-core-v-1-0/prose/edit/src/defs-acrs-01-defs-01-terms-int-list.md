...
EoX Core Extended Validator
:    An EoX Core Basic Validator that additionally performs recommended tests.

EoX Core Full Validator
...
:    An EoX Core Library that also satisfies the conformance target "EoX Core Full Validator".

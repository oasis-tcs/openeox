...
* **OpenEoX Core Actionable Viewer**: A program that satisfies the "OpenEoX Core Consumer" conformance profile and presents actionable interpretations by mapping lifecycle events to recommended actions.
